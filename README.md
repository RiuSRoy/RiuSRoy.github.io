...
#AA {
    ...
    background:blue;
    z-index: 9999;
    box-shadow: 10px 5px 5px saddlebrown;
    opacity:0.7;
...
#BB {
    ...
    right: 0px;
    bottom: 0px;
    background-image: url("http://wallpaper-gallery.net/images/flower-background-wallpaper/flower-background-wallpaper-10.jpg");
...
#head1{
	font-weight: bold;
	font-family: "Pacifico", Courier, cursive, monospace;
	font-size: 6vw;
	position: relative;
...
#head2{
	font-weight: bold;
	font-family: "Oleo Script", Courier, cursive, monospace;
	font-size: 6.5vw;
	position: relative;
